...
class LanguageJa extends BaseLanguage {
  ...
  @override String get mostReliablenRideRiderApp => '最も信頼できるnRideアプリ';
  ...
  @override String get noNearByDriverFound => 'おっと、近くにドライバーが見つかりません!';
  @override String get paymentSuccess => '支払い完了';
  @override String get safetyConcerns => '安全性の懸念';
  @override String get driverNotShown => 'ドライバーは現れなかった';
  @override String get noNeedRide => 'もう乗る必要はない';
  @override String get needToEditRide => '詳細を編集する必要がある';
  @override String get infoNotMatch => 'ドライバー/車両情報が一致しませんでした';
  @override String get rideCanceledByDriver => 'ドライバーによる乗車キャンセル';
  @override String get networkErr => 'ネットワークエラー';
  @override String get tryAgain => 'もう一度やり直してください';
  @override String get noConnected => 'ネットワーク接続を確認してください';
  @override String get rideComplete => '乗車完了の確認';
  @override String get detailScreen => '乗車詳細';
  @override String get bankInfoNotFound => '銀行情報が見つかりません';
  @override String get noBalanceValidate => '続行できません: ウォレットの残高が不足しています。';
  @override String get routingNumber => 'ルーティング番号';
  @override String get iban => '銀行IBAN';
  @override String get swift => '銀行スウィフトコード';
